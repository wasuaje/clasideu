...
#comando para el reinicio de apache
#DOAPACHE='/usr/local/apache-2.2.11/bin/apachectl restart'
DOAPACHE="sh /manduca10/netapp/clasificados/proyectos/scripts/apache_start_stop.sh"
...
#mail to developers and me
	...
	msg_arecord=msg_arecord+"Tambien se creo un archivo de configuracion para micrositio con el siguiente texto:\n\n"
...
#agregado en produccion en /micrositios de .33 para que reinicie el servidor apache
...
#cd $CLASIFICADOS_HOME/root/WEB-INF/classes; sudo -u manduca /usr/bin/java -cp $CLASIFICADOS_HOME/root/WEB-INF/lib/commons-io-1.2.jarCLASIFICADOS_HOME/root/WEB-INF/lib/commons-lang-2.4.jarCLASIFICADOS_HOME/root/WEB-INF/lib/commons-logging-1.1.1.jarCLASIFICADOS_HOME/root/WEB-INF/lib/freemarker-2.3.8.jarCLASIFICADOS_HOME/root/WEB-INF/lib/log4j-1.2.15.jarCLASIFICADOS_HOME/root/WEB-INF/lib/mail.jarCLASIFICADOS_HOME/root/WEB-INF/lib/ojdbc14.jarCLASIFICADOS_HOME/root/WEB-INF/lib/servlet-api.jarCLASIFICADOS_HOME/root/WEB-INF/lib/xstream-benchmark-1.2.2.jarCLASIFICADOS_HOME/root/WEB-INF/lib/xstream-1.2.2.jarCLASIFICADOS_HOME/root/WEB-INF/lib/moduloFotosTo.jarCLASIFICADOS_HOME/root/WEB-INF/lib/spring.jar:applicationContext-correo.xml:log4j.propertiespring-config.xml:. com.deu.clasificados.procesos.GenerarFotosLote
